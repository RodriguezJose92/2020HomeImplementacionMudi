...
class MudiExperience{
  ...
  createStyles(){
      ...
      link.href=`https://cdn.jsdelivr.net/gh/RodriguezJose92/2020HomeImplementacionMudi@latest/index.css`; /* custom this path */
  ...
  createTooltip(){
      ...
      setTimeout(()=>{  document.body.querySelector('.tooltipMudi').remove() },9000);
      return tooltip;
  };
  ...
  sendEventInteraction(eventName){
      ...
      window.dataLayer && dataLayer.push({
          event: `Evento de interaccion ${eventName} Mudi`,
          valorMudi: 1,
          sku: this.skuNumber,
          categoria:document.body.querySelector('.woocommerce-breadcrumb').children[2].innerHTML || 'null',
          subCategoria: document.body.querySelector('.woocommerce-breadcrumb').children[2].innerHTML || ' null',
  ...
  async experienceOn(skuNumber, fatherContainer){
      ...
      /** Viewer event GTM  */
      this.flagTesting && (this.sendEventViewer(), this.sendEventAddToCar() );
...
let skuNumer2020        = null;
let fatherContainer2020 = null;
let timeVerifyMudiExp   = 0

function verifyElements(){

  skuNumer2020        = document.querySelector('.sku');
  fatherContainer2020 = document.querySelector('.product-gallery');

  if(timeVerifyMudiExp>1000){
    return
  }else if ( skuNumer2020 && fatherContainer2020 ){
    mudiExperience.experienceOn( skuNumer2020.innerHTML , fatherContainer2020) ;
  }else{
    timeVerifyMudiExp ++;
    requestAnimationFrame(verifyElements)
  };
